...
module.exports = {
  ...
  JSON_STORE_FILE: process.env.JSON_STORE_FILE || "/data/litecoin-config.json",
  UMBREL_BITCOIN_CONF_FILEPATH: process.env.UMBREL_BITCOIN_CONF_FILE || "/litecoin/.litecoin/umbrel-litecoin.conf",
  BITCOIN_CONF_FILEPATH: process.env.BITCOIN_CONF_FILE || "/litecoin/.litecoin/litecoin.conf",
  BITCOIN_INITIALIZE_WITH_CLEARNET_OVER_TOR: process.env.BITCOIN_INITIALIZE_WITH_CLEARNET_OVER_TOR === 'true',
  BITCOIN_P2P_PORT: process.env.BITCOIN_P2P_PORT || 9333,
  BITCOIN_RPC_PORT: process.env.BITCOIN_RPC_PORT || 9332,
